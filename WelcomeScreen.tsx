      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-300 mb-8">
            "Step into tomorrow's AI — where minds and machines connect."
          </p>
        </div>
        ...
        {!hasApiKey ? (
          <div className="bg-gradient-to-br from-red-500/10 to-orange-500/10 border border-red-500/30 rounded-2xl p-8 mb-8">
            ...
            <p className="text-gray-300 mb-6">
              To start chatting, you'll need to configure your API keys. 
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-gray-800/30 border border-cyan-500/20 rounded-2xl p-6 backdrop-blur-sm hover:border-cyan-500/40 transition-all">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">"Talk Smart. Think Ahead."</h3>
                <p className="text-gray-400">"Experience intelligent, adaptive dialogues with next-gen AI."</p>
              </div>
              ...
              <div className="bg-gray-800/30 border border-green-500/20 rounded-2xl p-6 backdrop-blur-sm hover:border-green-500/40 transition-all">
                ...
                <p className="text-gray-400">"Choose from LLaMA 3, Mixtral, Gemma, and other powerful open-source AI models."</p>
              </div>
            </div>
